            ...
            ChapterSeed(
                ...
                slides = listOf(SlideSeed(
                    ...
                    bullets = listOf(
                        ...
                        "Bytes 11:08 and 15:12 are Command Dword 2 and Command Dword 3 (CDW2/CDW3) - reserved by most commands, but available as command-specific fields.",
                        ...
                        "An optional Vendor Specific command format swaps CDW10/CDW11 for explicit Number-of-Dwords transfer-length fields; Fabrics commands fix Opcode to 7Fh and add a Fabrics Command Type field instead.",
            ...
            ChapterSeed(
                ...
                slides = listOf(SlideSeed(
                    ...
                    bullets = listOf(
                        ...
                        "Fabrics commands use a different 16-byte layout (Figure 99): Fabrics Response Type Specific, SQ Head Pointer, Command Identifier, and a narrower Status field - SQ Identifier and Phase Tag don't apply over Fabrics.",
